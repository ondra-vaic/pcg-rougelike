package com.github.jroskopf.wfc

import com.github.jroskopf.wfc.model.Model
import com.github.jroskopf.wfc.model.SimpleTiledModel
import com.google.gson.Gson
import com.github.jroskopf.wfc.model.json.SampleJson
import java.io.File
import java.io.FileReader
import java.io.BufferedReader
import kotlin.random.Random
import com.github.jroskopf.wfc.model.json.Overlapping
import com.github.jroskopf.wfc.model.json.Simpletiled
            ...
            if(file.exists()) {
                ...
                data.samples?.all()?.forEach { commonModel ->
                    if (commonModel is Overlapping) {
                        val commonName = commonModel.name ?: ""
                        val imageFile = File("samples/$commonName.png")
